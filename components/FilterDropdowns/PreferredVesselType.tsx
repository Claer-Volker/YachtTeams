...
const data = [
  { label: "Dating Team", value: "Dating Team" },
  { label: "Professional Team", value: "Professional Team" },
  { label: "Friendship Team", value: "Friendship Team" },
];

const PreferredVesselType = () => {
  ...
  return (
    <View style={styles.container}>
      <MultiSelect
        ...
        labelField="label"
        valueField="value"
        placeholder="Preferred Vessel Type"
...
export default PreferredVesselType;
